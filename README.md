...
* dotnet UserManagement.Repository.csproj
  ```sh
...
* dotnet UserManagement.Core.csproj
  ```sh
  <TargetFramework>net6.0</TargetFramework>
  <ImplicitUsings>enable</ImplicitUsings>
  <Nullable>disable</Nullable>
  ```
* dotnet UserManagement.Service.csproj
  ```sh
...
1. Clone the repo
   ```sh
   https://github.com/BerkayKulak/UserManagement.git
   ```
...
If you find a bug (the website couldn't handle the query and / or gave undesired results), kindly open an issue [here](https://github.com/BerkayKulak/UserManagement/issues/new) by including your search query and the expected result.

If you'd like to request a new function, feel free to do so by opening an issue [here](https://github.com/BerkayKulak/UserManagement/issues/new). Please include sample queries and their corresponding results.
...
Project Link:   (https://github.com/BerkayKulak/UserManagement)
